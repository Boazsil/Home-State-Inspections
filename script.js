document.addEventListener('DOMContentLoaded', function () {
  ...
  // The quote form used to be handled here: it built a mailto: link and pushed the
  // browser at it, which opened a draft in the visitor's own email app and left them to
  // press send. That is gone. contact.html now posts straight to FormSubmit, so the
  // submission no longer depends on JavaScript running at all.
