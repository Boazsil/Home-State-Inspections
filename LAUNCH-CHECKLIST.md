...
the settings page, so either route works. Just do not delete the file afterwards, or the
...
`privacy-policy.html`, `404.html` and `thank-you.html` keep their `noindex` permanently, and
